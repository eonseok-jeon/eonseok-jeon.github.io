...
import { Container, MainTitle, SubTitle } from '../ReusableCSS';
import { StaticImage } from 'gatsby-plugin-image';
import styled from 'styled-components';

const PostArticle = styled(Container)`
  margin: 0 auto;
`;
...
const Post = () => {
  return (
    <PostArticle as="article">
      <div>
        <div>
          <MainTitle>새 포스트 제목입니다.</MainTitle>
          <p>@React / 23.09.28</p>
        </div>
        <StaticImage src="../../assets/imgs/test.png" alt="post-img" width={1200} height={600} />
        <SubTitle>포스트 부제목 입니다.</SubTitle>
      </div>
      <div>
        <p>드디어 SOPT YB 모집 공고가 떴다
