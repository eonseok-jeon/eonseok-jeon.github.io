...
const NextJS1 = () => {
  return (
    ...
    >
      <StaticImage src="../../../../assets/imgs/nextJS/1/8.png" alt="post-img" 
      ...
      <PostContentBox>
        ...
        <p>접속을 하기 위한 명령어는 인스턴스 아이디를 통해, 인스턴스 정보로 들어간 뒤, 오른쪽 상단의 ‘연결’버튼을 누르면</p>
        <PostImgBox>
...
git merge main
        ...
        <br />
        <p>merge하고 나서, 어찌어찌 없어진 아이콘 파일들 다 복구하고, 사라진 코드들 복사해서 붙여넣기 하고, npm run dev 했는데</p>
        <PostImgBox>
        ...
        <p>1번을 하려다가, develop과 완벽하게 동일한 코드를 가지면, git push origin develop 했을 때, 달라진 게 없다고, push가 안 될 거 같아서</p>
        <p>그냥 2번으로 하기로 했다</p>
        <p>main을 직접적으로 건드리는 거라 진짜 이 방법은 쓰고 싶지 않았는데 이대로 계속 가다간 제명에 살지 못할 거 같아 😇 빠르게 타협하였다</p>
        <p>자야 하는데,,</p>
        <br />
        ...
        <p>알고봤더니 conflict 해결하면서 코드들 박살나버려서 아예 버리고 새로 clone 했었는데, npm install을 안해줬던 것이었다</p>
        ...
        <PostImgBox>
          <StaticImage src="../../../../assets/imgs/nextJS/1/10.png" alt="nextJS-img-1-10" width={1000} height={400} />
        ...
        <p>처음엔 동적으로 주소 받는건데 getStaticPaths 안 해줘서 그런가? 하고 코드 작성을 해줬지만 여전히 오류가 발생하였다</p>
        ...
        <p>이유는 머리를 너무 많이 썼더니 어지러워져서 일단 찾지 않았고, 저 부분 삭제하고 바로 npm run build 해주었다</p>
        <br />
        <p>build 성공,,!!!!!!!!!!!!! 응애 💃🏻</p>
        <br />
        ...
        <p>그럼 https도,,? 실패!</p>
        <p>아 내 IP 주소를 설정 안 해줘서 그런가?! 실패! 아 오케이,,! 진짜 알았다,, 포트번호 3000번 안 열어줘서 그랬음!! 실패!</p>
        <br />
