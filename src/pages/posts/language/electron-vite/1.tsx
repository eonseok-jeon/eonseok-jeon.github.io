...
const ElectronVite1 = () => {
  return (
    <Post
      ...
      <StaticImage
        src="../../../../assets/imgs/no-image/3.png"
        alt="post-img"
      ...
      <R.PostContentBox>
        ...
        <br />
        <p>
          vite를 이용하니, vite.config.ts에 alias 설정해주고, tsconfig.json에 path 똑같이 설정해줬는데 해당 경로를
          import 하려고 하니 계속 빨간줄이 떴다
        </p>
        <br />
        <p>🤯🤯🤯</p>
        <br />
        ...
        <p>
          하지만 얘는 react-vite가 아닌 electron-vite이므로 vite.config.ts가 아니라, electron.vite.config.ts란 파일에
          설정을 해주어야 했다,,!!
        </p>
  ...
  renderer: {
    ...
    css: {
      preprocessorOptions: {
        ...
        잘 작동을 하였다! 진짜 제발 초기 코드는 다 분석을 해보쟈,,!!
      </R.PostContentBox>
    </Post>
  );
};
